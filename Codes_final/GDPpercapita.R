...
# X.ts = dbn.preprocessing(ts, window = 3)
# 
...
#           "C:\\Users\\sapta\\Documents\\Thesiswork\\Codes_final\\predicteddata\\PredictedGDPpc.csv",
#           row.names = FALSE)
...
yr = seq(1965, 2050)
preds <- predict(kayac.lm3, newdata = data.frame(x=yr), interval = 'confidence')
